...
const messages = {
  ...
  popup: {
    ...
    notificationSettings: {
      ...
      systemNotification: 'Try me !!!',
      systemNotificationDesc: 'Switch from slider to check box',
  ...
  popup: {
    ...
    notificationSettings: {
      ...
      systemNotification: 'تغيير النظام',
      systemNotificationDesc: 'تغيير صندوق الاختيار الئ صندوق التصحيح',
